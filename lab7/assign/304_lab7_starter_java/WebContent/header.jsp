<div class="row">
    ...
    if(session.getAttribute("authenticatedUser") != null) {
        ...
        out.println("<h3 class=\"col-md-3\" align=\"right\"><a href=\"admin.jsp\">Admin Portal</a> | <a href=\"listprod.jsp\"> Shop</a> | <a href=\"showcart.jsp\"> Cart</a> | <a href=\"customer.jsp\"> "+userName+"</a> | <a href=\"logout.jsp\">Log out</a></h3>");
