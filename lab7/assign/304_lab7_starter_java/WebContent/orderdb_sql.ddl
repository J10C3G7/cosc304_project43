...
INSERT INTO category(categoryName) VALUES ('Figurines');
...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('S.H Figurats Pac-Man', 2, '40th Anniversary Pac-Man Figurine',30.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Blue Ghost Pac-Man',2,'Vinyl Blue Ghost Pac-Man Figurine',45.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Pac-Man World PS1 Game',3,'Sony PlayStation 1 Video Game',10.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Donkey Kong 2008 Figure',2,'World of Nitendo Donkey Kong Series',50.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Donkey Kong Classic Game Poster',4,'24 x 36 inch poster',12.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Donkey Kong Country Disk',3,'Nitendo Game Boy Advance Game',30.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Street Fighter Alpha 2',4,'18 x 24 inches Game Poster',32.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('X-Men vs Street Fighter Poster',4,'24 x 36 inches Poster',80.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Street Fighter IV Ryu',2,'7" Action Figure Video Game',21.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('STREET FIGHTER SAGAT',2,'10" ROTOCAST SERIES ACTION FIGURE',55.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Mario Odyssey Cappy Hat',1,'Cosplay Accessory Costume',15.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Galaxian and Galaga Fighters',2,'Action Figure',225.50);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Galaga 1988 Arcade Video Game Retro',4,'18 x 24 inches Print Poster',25.50);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Rampage Stretch Lizzy',2,'Action Figure',30.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('RAMPAGE 2: Universal Tour ',3,'Sony PlayStation 1 Disk',27.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Contra - Bill Rizer',2,'Action Figure',17.50);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('2002 Spy Hunter Framed Print',4,'24 x 36 Poster Original PS2',55.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Teenage Mutant Ninja Turtles comic',5,'Comic',12.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('THE LAST RONIN Teenage Mutant Ninja',2,'Ninja Turtles Figure 6” Legends',150.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Road Rash PC',3,'Racing Video Game',25.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Pacman Epic Fail T-shirt',6,'Pac-Man T-shirt',25.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Batman Vol. 1',5,'DC Comic',15.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('McFarlane Mortal Kombat 11 Spawn Lordt',2,'7" ActionFigure',22.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Mortal Kombat Logo T-shirt',6,'Mortal Kombat T-Shirt',20.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Super Mario Bros. 3',4,'Poster',18.40);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Green Lantern New Journey Old Path',5,'DC Comics 1st Print',13.50);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Star Wars Master Trooper Helmet',1,'Star trooper Helmet',1500.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Star Wars Empire Strikes Back',4,'Movie Poster',21.05);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Star Wars Return Of The Jedi',3,'Nintendo GameBoy Wata Cross',1150.00);
...
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, admin) VALUES ('Arnold', 'Anders', 'a.anders@gmail.com', '204-111-2222', '104 AnyWhere Street', 'Winnipeg', 'MB', 'R3X 44T', 'Canada', 'admin' , 'test', 'true');
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, admin) VALUES ('Arnold', 'Anderson', 'a.anderson@gmail.com', '204-111-2222', '103 AnyWhere Street', 'Winnipeg', 'MB', 'R3X 45T', 'Canada', 'arnold' , 'test', 'false');
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, admin) VALUES ('Bobby', 'Brown', 'bobby.brown@hotmail.ca', '572-342-8911', '222 Bush Avenue', 'Boston', 'MA', '22222', 'United States', 'bobby' , 'bobby', 'false');
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, admin) VALUES ('Candace', 'Cole', 'cole@charity.org', '333-444-5555', '333 Central Crescent', 'Chicago', 'IL', '33333', 'United States', 'candace' , 'password', 'false');
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, admin) VALUES ('Darren', 'Doe', 'oe@doe.com', '250-807-2222', '444 Dover Lane', 'Kelowna', 'BC', 'V1V 2X9', 'Canada', 'darren' , 'pw', 'false');
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, admin) VALUES ('Elizabeth', 'Elliott', 'engel@uiowa.edu', '555-666-7777', '555 Everwood Street', 'Iowa City', 'IA', '52241', 'United States', 'beth' , 'test', 'false');
